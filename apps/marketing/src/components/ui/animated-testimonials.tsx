      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
            ...
            <AnimatePresence>
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div
                    className={cn(
                      'relative h-full w-full rounded-3xl p-8 bg-card border border-border',
                      isActive(index) ? 'shadow-2xl' : 'shadow-lg'
                    )}
                  >
                    ...
                    <motion.p className="text-base text-foreground mt-8 leading-relaxed">
                      {testimonial.quote}
                    </motion.p>
                  </div>
                </motion.div>
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          >
            ...
            <motion.p className="text-lg text-foreground mt-8 leading-relaxed">
