...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Primary brand colors - Black (Uber-like) + Teal accent
        primary: {
          50: '#f0fdf4',
          100: '#dcfce7',
          200: '#bbf7d0',
          ...
          900: '#14532d',
          950: '#052e16',
          DEFAULT: '#000000', // Black as primary
        },
        // Teal accent color
        accent: {
          50: '#f0fdfa',
      ...
      boxShadow: {
        ...
        // Premium elevated shadows with teal glow
        ...
        'card-hover': '0 4px 12px 0 rgba(0, 0, 0, 0.3), 0 2px 6px -2px rgba(0, 0, 0, 0.3)',
      },
      borderRadius: {
        'none': '0',
        'sm': '0.25rem',
